...
<html lang="pt-br">
    <head>
        ...
        <script type="text/javascript">
            function check() {
                if (frm.usuario_id.value == "") {
                    alert("Por favor, informe o ID do usuário a ser pesquisado.");
                    frm.usuario_id.focus();
                    return false;
                }
            }
        </script>
                        ...
                        <div class="hero" >
                            <div class="well" >
                                ...
                                <form id="frm" onsubmit="return check(this);" class="form-search" method="post" action="${pageContext.request.contextPath}/UsuarioServlet">
                                    ...
                                    <td class="label"><h5>ID do Usuário a ser excluído:</h5></td>
