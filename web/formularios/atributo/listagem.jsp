        ...
        <div class="container-fluid">
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <!-- FIM DO CABEÇALHO -->
                    <span class="label label-success"><h3>Atributos Cadastrados</h3></span>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody class="table-hover">
                            ...
                            <jsp:useBean id="servicos" scope="page" class="cpabe.servicos.AtributoServices"/>

                            <c:forEach items="${servicos.todos}" var="atributo">
                                <tr>
                                    <td>${atributo.atributo_id}</td>
                                    <td>${atributo.atributo_nome}</td>
                                    <td>${atributo.atributo_descricao}</td>                                    
                                    <td><a href="${pageContext.request.contextPath}/AtributoServlet?acao=prepAlteracao&atributo_id=${atributo.atributo_id}"><button class="btn btn-mini btn" type="button">Alterar</button></a></td>
                                    <td><a href="${pageContext.request.contextPath}/AtributoServlet?acao=prepExclusao&atributo_id=${atributo.atributo_id}"><button class="btn btn-mini btn-danger" type="button">Excluir</button></a></td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
