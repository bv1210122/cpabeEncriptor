            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="hero">
                        <div class="container-fluid">
                            <div class="well">
                                <span class="label label-success"><h3>Gerar Chave Privada</h3></span>
                                <h4>Orientações Gerais:</h4>
                                <p>Para gerar a chave privada para determinado usuário, basta selecionar o usuário desejado</p>
                                <form id="frm" class="validate" onsubmit="return validaForm(this);" method="post" action="${pageContext.request.contextPath}/CPABEServlet">
                                    ...
                                    <label>Usuário: </label> 
                                    <jsp:useBean id="ususervicos" scope="page" class="cpabe.servicos.UsuarioServices"/>
                                    <select name="usuario_id">
                                        <option value="0">--- Selecione ---</option> 
                                        <c:forEach items="${ususervicos.todos}" var="usuario">
                                            <option value="${usuario.usuario_id}">${usuario.usuario_user}</option>
                                        </c:forEach>
                                    </select>                                    
                                    <br>
                                    <br>
