        ...
        <script type="text/javascript">
            function check() {
                if (frm.atributo_id.value == "") {
                    alert("Por favor, informe o ID do genero a ser pesquisado.");
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="container-fluid">
                        <div class="hero" >
                            <div class="well" >
                                <span class="label label-success"><h3>Excluir Atributo</h3></span>
                                <form id="frm" onsubmit="return check(this);" class="form-search" method="post" action="${pageContext.request.contextPath}/AtributoServlet">
                                    <input name="acao" type="hidden" value="prepExclusao"/>
                                    <td class="label"><h5>ID do Atributo a ser excluído:</h5></td>
                                    <div class="input-append">
                                        <input class="span6 search-query" type="text" name="atributo_id">
                                        <button  class="btn btn-primary" type="submit" value="prepExclusao">Buscar</button>
                                    </div>
                                    <table>
                                        <tr>
