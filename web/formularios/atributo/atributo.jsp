            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="hero">
                        <div class="container-fluid">
                            <div class="well">
                                <span class="label label-success"><h3>Cadastro de Atributos</h3></span>
                                <h4>Dados Gerais do Atributo</h4>
                                <form id="frm" class="validate" onsubmit="return validaForm(this);" method="post" action="${pageContext.request.contextPath}/AtributoServlet">
                                    ...
                                    <label>Nome: </label>
                                    <input placeholder="Digite o Nome" type="text" size="20" name="atributo_nome" />
                                    <br/>
                                    <label>Descrição:</label>
                                    <textarea placeholder="Apresente uma breve Descrição do Atributo. Ex: Pertencente aos quadros de funcionário do Setor X." rows="5" name="atributo_descricao" class="input-xxlarge"></textarea>
                                    <br>
                                    <br>
