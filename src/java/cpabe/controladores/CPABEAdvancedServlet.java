...
/**
 * Servlet para tratar Criptografia CPABE no modo Advanced.
 *
 * @author BV1210122
 */
public class CPABEAdvancedServlet extends HttpServlet {
    ...
    protected void processRequest(
        ...
        try {
            ...
            if (acao.equals("gerar_chave_privada")) {
                ...
                String nome_chave = request.getParameter("nome_chave");
                String atributo_chave_advanced = request.getParameter("atributo_chave_advanced");

                exe.executeCommand("/home/aluno/cpabe-0.11/cpabe-keygen -o /home/aluno/cpabe-0.11/users_keys/" + nome_chave + "_pk /home/aluno/cpabe-0.11/system_keys/pub_key /home/aluno/cpabe-0.11/system_keys/master_key " + atributo_chave_advanced + "");
                ...
                try {
                    ...
                    out.println("<p>O atributo " + atributo_chave_advanced + " foi vinculado à Chave Privada gerada!</p>");
                ...
                String atributo_advanced = request.getParameter("atributo_advanced");
                String fileName = request.getParameter("fileName");
                String caminho = request.getParameter("arquivo");

                System.out.println(atributo_advanced);                
                System.out.println(fileName);
                System.out.println(caminho);

                exe.executeCommand("/home/aluno/cpabe-0.11/cpabe-enc /home/aluno/cpabe-0.11/system_keys/pub_key " + caminho + " '" + atributo_advanced + "'");
                ...
                try {
                    ...
                    out.println("<p>" + caminho + " criptografado com o(s) atributo(s) " + atributo_advanced + "</p>");
...
// <editor-fold defaultstate="collapsed" desc="HttpServlet methods. Click on the + sign on the left to edit the code.">
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(CPABEAdvancedServlet.class
