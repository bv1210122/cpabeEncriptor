                    ...
                    <div class="hero">
                        <div class="container-fluid">
                            <div class="well">
                                ...
                                <br>
                                <p>Agora vamos selecionar a chave privada com a qual se pretende fazer a decodificação do arquivo:</p>
                                <form id="frm" class="validate" onsubmit="return validaForm(this);" method="post" action="${pageContext.request.contextPath}/CPABEServlet">
                                    <input name="acao" type="hidden" value="descriptografar">
                                    <label> Arquivo Selecionado: </label>${requestScope.caminho.nome}
                                    <input name="fileName" type="hidden" value="${requestScope.caminho.nome}" >
                                    <input type="hidden" name="arquivo_criptografado"  class="input-large" value="${requestScope.caminho.way}" >
                                    <label> Chave Privada Selecionada: </label>${requestScope.caminho.chave}
                                    <input type="hidden" name="chave_privada"  class="input-large" value="${requestScope.caminho.chave}" >
                                    <br>
                                    <br>
                                    <button class="btn btn-primary" type="submit" value="descriptografar">Descriptografar</button>
