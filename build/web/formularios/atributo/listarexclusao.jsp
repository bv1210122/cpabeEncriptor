                    ...
                    <div class="container-fluid">
                        <div class="hero" >
                            <div class="well" >
                                ...
                                <form method="post" action="${pageContext.request.contextPath}/AtributoServlet">
                                    <input name="atributo_id" type="hidden" value="${requestScope.atributo.atributo_id}"/>
                                    <table>
                                        <tr>
                                    ...
                                    <table>
                                        <tr colspan="2">
                                            <td colspan="2" class="label">Para efetuar a exclusão, clique no botão abaixo:</td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <button  class="btn btn-large btn-block btn-danger" onclick="informarExclusao();" name="acao"  type="submit" value="excluir">Excluir</button>
                                            </td>
                                        </tr>
                                    </table>
                                </form>
